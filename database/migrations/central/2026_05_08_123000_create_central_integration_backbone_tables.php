...
return new class extends Migration
{
    ...
    {
        if (! Schema::connection($this->connection)->hasTable('evento_outboxes')) {
        ...
        if (! Schema::connection($this->connection)->hasTable('entregas_integracao')) {
        ...
        if (! Schema::connection($this->connection)->hasTable('contratos_evento')) {
